...
class DL
{
    static $myName="DataLogic";
    static $limit=10;
    static $offset=1;
    static $queryPaginationArray=['page','records'];
    //static $loginArray=['pin|string','api_key|string','user|string'];
    //static $showUser=array('email'=>'1~eml~100');
    static $validateArray=[''=>'','user/users'=>'listUserArray',];
    static $arbTokenType=1;
    static $apiTokenType=2;
    static $pinTokenType=3;
    static $shortTokenType=4;
    static $longTokenType=5;
    static $gaSecretToken=6;
    static $userTokenTypesArray=array('6'=>'GoogleAuthSecret');
